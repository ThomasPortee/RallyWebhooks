...
var options = {
  ...
  url: "https://rally1.rallydev.com/apps/pigeon/api/v2/webhook/e4e88584-a3d5-4838-a9f0-629eff45167f", // Development Environment
  headers: {
...
request(options, function (error, response, body) {
  ...
  console.log(`Update webhook: ${body._ref} (${body.Name})`);
  var nyc = body;
  var propValue;
