...
module.exports.doesRuleApply = (message) => {
  ...
  if (result) {
    log.info("rule caibenefit_changed_rule applies");
  }
  else {
    log.warn("rule caibenefit_changed_rule does NOT apply");
  }
  return result
}
...
module.exports.run = (message) => {
  var result = new Promise((resolve, reject) => {
    if (message) {
      ...
      //const check_fields = ['c_CAIBenefit', 'c_CAIBenefit', 'c_Strategy'] // Startegy is OFF


      const check_fields = ['c_CAIBenefit'] // Strategy is OFF
